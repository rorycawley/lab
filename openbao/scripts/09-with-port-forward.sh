...
COMMAND="${1:-test}"
PORT_FORWARD_LOG="${PORT_FORWARD_LOG:-/tmp/openbao-demo-port-forward.log}"
...
rm -f "$PORT_FORWARD_LOG"
kubectl port-forward -n "$NAMESPACE" service/openbao-demo-app 8080:8080 >"$PORT_FORWARD_LOG" 2>&1 &
PORT_FORWARD_PID="$!"
